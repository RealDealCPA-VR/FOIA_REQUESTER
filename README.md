...
Adding New Features
New AI Generation Type: Add to lib/ai/openai.ts and create corresponding API route
New Form Fields: Update schema in lib/db/schema.ts and form in components/foia-request-form.tsx
Agency Integration: Add agency data to agencies and agency_components tables
📊 Database Migrations
